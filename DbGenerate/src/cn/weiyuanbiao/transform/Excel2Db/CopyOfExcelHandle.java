...
public class CopyOfExcelHandle{
...
//	  					 ColumnEntity fe = new ColumnEntity();
//	  					 fe.setFieldName(py.HanyuToPinyinTou(as[j]));
//	  					 fe.setFieldNote(as[j]);
//	  					 fe.setFieldType("VARCHAR2");
//	  					 fe.setFieldLength("100");
//	  					 listFe.add(fe);
//				}
...
//		}
		create_tables("RPT_GRP","temp4.xls");
//		create_tables("users");
	}
}
