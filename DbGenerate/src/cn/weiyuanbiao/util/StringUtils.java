...
public class StringUtils extends StringUtil {
	...
	public static String filterStr(String regex,String str){
		return str.replaceFirst(regex, "");
	}
	
	public static void main(String[] args) {
		String a = "t_zc_user";
		String b = "t_sys_|t_zc_";
//		String s = StringUtils.toCenterUpperCase(a.substring(a.indexOf(b)+b.length(), a.length()));
		String s = StringUtils.toCenterUpperCase(filterStr(b, a));
		String s1 = StringUtils.firstToUpper(s);
